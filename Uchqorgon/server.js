...
const channelChatId = '@uchqorgon_defend_korrupsiya';
...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(chatId, `Assalomu alaykum hurmatli ${msg.from.first_name}, siz Uchqorg\`on tumani tibbiyot birlashmasining biz Korrupsiyaga qarshimiz botiga xush kelibsiz!`, {
        reply_markup: {
